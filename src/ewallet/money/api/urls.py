...
urlpatterns = [
    ...
    path('transactions/<int:id>', TransactionView.as_view(),name='delete-transactions'),
    path('transactions/<str:wallet_slug>', TransactionView.get_by_wallet,name='get-transactions-by-wallet'),
